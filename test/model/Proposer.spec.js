...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.Proposer();
  });
  ...
  describe('Proposer', function() {
    it('should create an instance of Proposer', function() {
      // uncomment below and update the code to test Proposer
      //var instane = new CetLiteForCoinExChain.Proposer();
      //expect(instance).to.be.a(CetLiteForCoinExChain.Proposer);
    });
