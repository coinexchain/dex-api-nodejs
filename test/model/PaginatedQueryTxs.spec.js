...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.PaginatedQueryTxs();
  });
  ...
  describe('PaginatedQueryTxs', function() {
    it('should create an instance of PaginatedQueryTxs', function() {
      ...
      //var instane = new CetLiteForCoinExChain.PaginatedQueryTxs();
      //expect(instance).to.be.a(CetLiteForCoinExChain.PaginatedQueryTxs);
    });
