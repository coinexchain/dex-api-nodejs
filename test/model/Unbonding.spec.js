...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.Unbonding();
  });
  ...
  describe('Unbonding', function() {
    it('should create an instance of Unbonding', function() {
      // uncomment below and update the code to test Unbonding
      //var instane = new DexApiNodejs.Unbonding();
      //expect(instance).to.be.a(DexApiNodejs.Unbonding);
    });
