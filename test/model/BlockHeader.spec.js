...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.BlockHeader();
  });
  ...
  describe('BlockHeader', function() {
    it('should create an instance of BlockHeader', function() {
      ...
      //var instane = new CetLiteForCoinExChain.BlockHeader();
      //expect(instance).to.be.a(CetLiteForCoinExChain.BlockHeader);
    });
