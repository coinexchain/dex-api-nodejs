...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.ValidatorDistInfo();
  });
  ...
  describe('ValidatorDistInfo', function() {
    it('should create an instance of ValidatorDistInfo', function() {
      ...
      //var instane = new CetLiteForCoinExChain.ValidatorDistInfo();
      //expect(instance).to.be.a(CetLiteForCoinExChain.ValidatorDistInfo);
    });
