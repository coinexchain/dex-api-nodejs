...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.StdTxCoreSignatures();
  });
  ...
  describe('StdTxCoreSignatures', function() {
    it('should create an instance of StdTxCoreSignatures', function() {
      // uncomment below and update the code to test StdTxCoreSignatures
      //var instane = new DexApiNodejs.StdTxCoreSignatures();
      //expect(instance).to.be.a(DexApiNodejs.StdTxCoreSignatures);
    });
