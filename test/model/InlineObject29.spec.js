...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.InlineObject29();
  });
  ...
  describe('InlineObject29', function() {
    it('should create an instance of InlineObject29', function() {
      ...
      //var instane = new DexApiNodejs.InlineObject29();
      //expect(instance).to.be.a(DexApiNodejs.InlineObject29);
    });
    ...
    it('should have the property isAdd (base name: "is_add")', function() {
      // uncomment below and update the code to test the property isAdd
      //var instane = new DexApiNodejs.InlineObject29();
      //expect(instance).to.be();
    });

    it('should have the property asDefault (base name: "as_default")', function() {
      // uncomment below and update the code to test the property asDefault
      //var instane = new DexApiNodejs.InlineObject29();
      //expect(instance).to.be();
    });
