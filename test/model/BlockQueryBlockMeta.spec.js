...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.BlockQueryBlockMeta();
  });
  ...
  describe('BlockQueryBlockMeta', function() {
    it('should create an instance of BlockQueryBlockMeta', function() {
      // uncomment below and update the code to test BlockQueryBlockMeta
      //var instane = new DexApiNodejs.BlockQueryBlockMeta();
      //expect(instance).to.be.a(DexApiNodejs.BlockQueryBlockMeta);
    });
