...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.TendermintValidator();
  });
  ...
  describe('TendermintValidator', function() {
    it('should create an instance of TendermintValidator', function() {
      ...
      //var instane = new CetLiteForCoinExChain.TendermintValidator();
      //expect(instance).to.be.a(CetLiteForCoinExChain.TendermintValidator);
    });
