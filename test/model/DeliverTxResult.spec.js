...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.DeliverTxResult();
  });
  ...
  describe('DeliverTxResult', function() {
    it('should create an instance of DeliverTxResult', function() {
      // uncomment below and update the code to test DeliverTxResult
      //var instane = new CetLiteForCoinExChain.DeliverTxResult();
      //expect(instance).to.be.a(CetLiteForCoinExChain.DeliverTxResult);
    });
