...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.KeyOutput();
  });
  ...
  describe('KeyOutput', function() {
    it('should create an instance of KeyOutput', function() {
      // uncomment below and update the code to test KeyOutput
      //var instane = new CetLiteForCoinExChain.KeyOutput();
      //expect(instance).to.be.a(CetLiteForCoinExChain.KeyOutput);
    });
