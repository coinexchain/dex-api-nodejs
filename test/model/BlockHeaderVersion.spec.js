...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.BlockHeaderVersion();
  });
  ...
  describe('BlockHeaderVersion', function() {
    it('should create an instance of BlockHeaderVersion', function() {
      // uncomment below and update the code to test BlockHeaderVersion
      //var instane = new DexApiNodejs.BlockHeaderVersion();
      //expect(instance).to.be.a(DexApiNodejs.BlockHeaderVersion);
    });
