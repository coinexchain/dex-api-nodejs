...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.InlineObject17();
  });
  ...
  describe('InlineObject17', function() {
    it('should create an instance of InlineObject17', function() {
      ...
      //var instane = new DexApiNodejs.InlineObject17();
      //expect(instance).to.be.a(DexApiNodejs.InlineObject17);
    });
    ...
    it('should have the property withdrawAddress (base name: "withdraw_address")', function() {
