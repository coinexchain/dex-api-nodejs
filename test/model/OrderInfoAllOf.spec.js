...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.OrderInfoAllOf();
  });
  ...
  describe('OrderInfoAllOf', function() {
    it('should create an instance of OrderInfoAllOf', function() {
      // uncomment below and update the code to test OrderInfoAllOf
      //var instane = new DexApiNodejs.OrderInfoAllOf();
      //expect(instance).to.be.a(DexApiNodejs.OrderInfoAllOf);
    });
