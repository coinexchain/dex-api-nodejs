...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CetLiteForCoinExChain.CheckTxResult();
  });
  ...
  describe('CheckTxResult', function() {
    it('should create an instance of CheckTxResult', function() {
      // uncomment below and update the code to test CheckTxResult
      //var instane = new CetLiteForCoinExChain.CheckTxResult();
      //expect(instance).to.be.a(CetLiteForCoinExChain.CheckTxResult);
    });
