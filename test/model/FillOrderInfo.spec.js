...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DexApiNodejs.FillOrderInfo();
  });
  ...
  describe('FillOrderInfo', function() {
    it('should create an instance of FillOrderInfo', function() {
      // uncomment below and update the code to test FillOrderInfo
      //var instane = new DexApiNodejs.FillOrderInfo();
      //expect(instance).to.be.a(DexApiNodejs.FillOrderInfo);
    });
    ...
    it('should have the property currStock (base name: "curr_stock")', function() {
      // uncomment below and update the code to test the property currStock
      //var instane = new DexApiNodejs.FillOrderInfo();
      //expect(instance).to.be();
    });

    it('should have the property currMoney (base name: "curr_money")', function() {
      // uncomment below and update the code to test the property currMoney
      //var instane = new DexApiNodejs.FillOrderInfo();
      //expect(instance).to.be();
    });
