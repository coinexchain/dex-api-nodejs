    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = ApiClient.convertToType(data['result'], [TextProposal]);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20018.prototype['height'] = undefined;

/**
 * @member {Array.<module:model/TextProposal>} result
 */
InlineResponse20018.prototype['result'] = undefined;
