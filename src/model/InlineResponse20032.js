...
import ValidatorDistInfo from './ValidatorDistInfo';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = ValidatorDistInfo.constructFromObject(data['result']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20032.prototype['height'] = undefined;

/**
 * @member {module:model/ValidatorDistInfo} result
 */
InlineResponse20032.prototype['result'] = undefined;
