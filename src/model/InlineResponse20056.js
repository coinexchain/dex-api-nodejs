...
import FillOrderInfo from './FillOrderInfo';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [FillOrderInfo]);
            }
...
/**
 * @member {Array.<module:model/FillOrderInfo>} data
 */
 ...
 */
InlineResponse20056.prototype['timesid'] = undefined;
