...
import DelegatorTotalRewards from './DelegatorTotalRewards';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = DelegatorTotalRewards.constructFromObject(data['result']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20029.prototype['height'] = undefined;

/**
 * @member {module:model/DelegatorTotalRewards} result
 */
