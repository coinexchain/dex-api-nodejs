    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = ApiClient.convertToType(data['result'], [Coin]);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20030.prototype['height'] = undefined;

/**
 * @member {Array.<module:model/Coin>} result
 */
InlineResponse20030.prototype['result'] = undefined;
