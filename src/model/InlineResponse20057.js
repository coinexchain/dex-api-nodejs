...
import BancorTrade from './BancorTrade';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [BancorTrade]);
            }
...
/**
 * @member {Array.<module:model/BancorTrade>} data
 */
 ...
 */
InlineResponse20057.prototype['timesid'] = undefined;
