...
import InlineResponse20050Result from './InlineResponse20050Result';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = InlineResponse20050Result.constructFromObject(data['result']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20050.prototype['height'] = undefined;

/**
 * @member {module:model/InlineResponse20050Result} result
 */
