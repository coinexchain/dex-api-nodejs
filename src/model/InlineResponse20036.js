...
import InlineResponse20036Result from './InlineResponse20036Result';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('result')) {
                obj['result'] = InlineResponse20036Result.constructFromObject(data['result']);
            }
        }
        return obj;
    }
 ...
 */
InlineResponse20036.prototype['height'] = undefined;

/**
 * @member {module:model/InlineResponse20036Result} result
 */
