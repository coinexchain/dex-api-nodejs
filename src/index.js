...
* <pre>
* var CetLiteForCoinExChain = require('index'); // See note below*.
* var xxxSvc = new CetLiteForCoinExChain.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CetLiteForCoinExChain.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CetLiteForCoinExChain.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CetLiteForCoinExChain.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
