# CetLiteForCoinExChain.MarketApi
...
let apiInstance = new CetLiteForCoinExChain.MarketApi();
...
apiInstance.cancelTradingPair(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CetLiteForCoinExChain.MarketApi();
let body = new CetLiteForCoinExChain.ModelObject(); // ModelObject | create order tx

apiInstance.createGteOrder(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.createIocOrder(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CetLiteForCoinExChain.MarketApi();
let body = new CetLiteForCoinExChain.ModelObject(); // ModelObject | Create trading-pair

apiInstance.createTradingPair(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CetLiteForCoinExChain.MarketApi();
apiInstance.getMarketParams((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getOrders(address, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getOrdersInMarket(stock, money, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getTradingPair(stock, money, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.modifyPricePrecision(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CetLiteForCoinExChain.MarketApi();
apiInstance.queryTradingPairs((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
